      ...
      <div className="sticky top-16 z-40 bg-gray-50 pt-4 pb-2 px-4 shadow-sm">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm">Pesquisa de materiais em atas</p>
          </div>
        </div>
      ...
      <div className="p-4 space-y-6">
        {loading ? (
          ...
          <EmptyState
            ...
            description={temFiltrosAtivos ? "Tente ajustar os filtros" : "Não há materiais com ata"}
          />
        ) : (
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="font-semibold text-gray-900">
                    {itens.length} {itens.length === 1 ? 'material encontrado' : 'materiais encontrados'}
                  </h2>
